@extends('layouts.app')
@section('title', 'Data Rental - Rental Car')
@section('content')
<style>
...
<div class="container py-5">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('rentals.create') }}" class="btn btn-action btn-add">
    ...
    <div class="search-container">
        <form action="{{ route('rentals.index') }}" method="GET">
            <div class="row g-3">
                <div class="col-md-4">
                    <input type="text" name="customer" class="form-control" placeholder="🔍 Cari Customer..." value="{{ request('customer') }}">
                </div>
                <div class="col-md-4">
                    <input type="text" name="car" class="form-control" placeholder="🚗 Cari Mobil..." value="{{ request('car') }}">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-12 text-center">
                    ...
                    <a href="{{ route('rentals.index') }}" class="btn btn-action btn-back ms-2">
                ...
                <tbody>
                    @forelse($rentals as $index => $rental)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('rentals.edit', $rental->id) }}" class="btn btn-table btn-edit">

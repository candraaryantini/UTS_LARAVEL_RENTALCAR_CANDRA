...
@section('title', 'Data Customers - Rental Car')
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('customers.create') }}" class="btn btn-action btn-add">
            ...
            <table class="table">
                ...
                <tbody>
                    @forelse ($customers as $index => $customer)
                        <tr>
                            <td><strong>{{ $loop->iteration + ($customers->currentPage() - 1) * $customers->perPage() }}</strong></td>
                            <td>
                            ...
                            <td class="text-center">
                                <a href="{{ route('customers.edit', $customer->id) }}" class="btn btn-table btn-edit">

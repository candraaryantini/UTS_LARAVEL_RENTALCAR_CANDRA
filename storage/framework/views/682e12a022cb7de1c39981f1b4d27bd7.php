    ...
    <div class="form-container">
        ...
        <form action="<?php echo e(route('rentals.store')); ?>" method="POST" id="rentalForm">
            ...
            <div class="mb-3">
                ...
                <select name="car_id" id="car_id" class="form-select <?php $__errorArgs = ['car_id'];
...
unset($__errorArgs, $__bag); ?>" 
                       step="1" min="0" value="<?php echo e(old('total_price')); ?>" 
...
unset($__errorArgs, $__bag); ?>" required>
                    ...
                    <option value="ongoing" <?php echo e(old('status', 'ongoing') == 'ongoing' ? 'selected' : ''); ?>>
                        🟢 Sedang Berlangsung
                    </option>

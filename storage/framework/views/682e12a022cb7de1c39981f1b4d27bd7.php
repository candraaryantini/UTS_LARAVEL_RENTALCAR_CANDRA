...
<?php $__env->startSection('title', 'Tambah Rental - Rental Car'); ?>
...
<div class="container py-5">
    <div class="form-container">
        ...
        <!-- Form -->
        <form action="<?php echo e(route('rentals.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-row mb-3">
                <div>
                    ...
                    <input type="date" name="rental_date" id="rental_date"
                           class="form-control" value="<?php echo e(old('rental_date')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="return_date" id="return_date"
                           class="form-control" value="<?php echo e(old('return_date')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="total_price" id="total_price"
                       class="form-control" step="0.01" value="<?php echo e(old('total_price')); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_rentalcar\resources\views/rentals/create.blade.php ENDPATH**/ ?>
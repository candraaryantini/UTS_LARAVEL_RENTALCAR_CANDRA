    ...
    <div class="detail-container">
        ...
        <?php if($car): ?>
            ...
            <div class="detail-table">
                <table>
                    <tr>
                        ...
                        <td><strong>#<?php echo e($car->id); ?></strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($car->color ?? 'Tidak tersedia'); ?></td>
                    </tr>
                    <tr>
                        <th><i class="bi bi-credit-card-2-front me-2"></i>Plat Nomor</th>
                        <td><strong><?php echo e($car->license_plate); ?></strong></td>
                    </tr>
                    <tr>
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('cars.index')); ?>" class="btn-action btn-back">
                    <i class="bi bi-arrow-left me-2"></i>
                    Kembali
                </a>
                <a href="<?php echo e(route('cars.edit', $car->id)); ?>" class="btn-action btn-edit">
        ...
        <?php else: ?>
            ...
            <div class="empty-state">
                ...
                <a href="<?php echo e(route('cars.index')); ?>" class="btn-action btn-back mt-3">
                    <i class="bi bi-arrow-left me-2"></i>
                    Kembali ke Daftar
                </a>
            </div>

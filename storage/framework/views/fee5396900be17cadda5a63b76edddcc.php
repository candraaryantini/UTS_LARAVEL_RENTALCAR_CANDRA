...
<?php $__env->startSection('title', 'Data Mobil - Rental Car'); ?>
...
<div class="container py-4">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?php echo e(route('cars.create')); ?>" class="btn btn-action btn-add">
    ...
    <div class="search-container">
        <form method="GET" action="<?php echo e(route('cars.index')); ?>" class="row g-3">
            <div class="col-md-10">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><strong><?php echo e($cars->firstItem() + $index); ?></strong></td>
                            <td><strong><?php echo e($car->brand); ?></strong></td>
                            <td><?php echo e($car->model); ?></td>
                            <td><span class="badge bg-secondary"><?php echo e($car->license_plate); ?></span></td>
                            <td><?php echo e($car->year); ?></td>
                            <td class="price-text">Rp <?php echo e(number_format($car->price_per_day, 0, ',', '.')); ?></td>
                            <td>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('cars.show', $car->id)); ?>" class="btn btn-table btn-view">
                                    <i class="bi bi-eye"></i> Lihat
                                </a>
                                <a href="<?php echo e(route('cars.edit', $car->id)); ?>" class="btn btn-table btn-edit">
                                    <i class="bi bi-pencil"></i> Edit
                                </a>
                                <form action="<?php echo e(route('cars.destroy', $car->id)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_rentalcar\resources\views/cars/index.blade.php ENDPATH**/ ?>
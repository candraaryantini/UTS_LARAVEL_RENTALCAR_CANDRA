...
<?php $__env->startSection('title', 'Dashboard - Rental Car'); ?>
...
<div class="container py-5">
        ...
        <div class="col-md-4">
            <div class="card stat-card bg-primary-gradient shadow-lg">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('cars.index')); ?>" class="btn btn-manage mt-3">
        ...
        <div class="col-md-4">
            <div class="card stat-card bg-success-gradient shadow-lg">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('customers.index')); ?>" class="btn btn-manage mt-3">
        ...
        <div class="col-md-4">
            <div class="card stat-card bg-warning-gradient shadow-lg">
                <div class="card-body text-center">
                    ...
                    <h3><?php echo e($totalRentals); ?></h3>
                    <a href="<?php echo e(route('rentals.index')); ?>" class="btn btn-manage mt-3">
            ...
            <div class="col-lg-6">
                <div class="info-card">
                    ...
                    <div class="stat-item">
                        ...
                        <div class="value"><?php echo e($totalCars - ($activeRentals ?? 0)); ?></div>
                    </div>
                    ...
                    <div class="stat-item">
                        ...
                        <div class="value"><?php echo e($activeRentals ?? 0); ?></div>
                    </div>
                    ...
                    <div class="stat-item">
                        ...
                        <div class="value"><?php echo e($maintenanceCars ?? 0); ?></div>
                    </div>

                    <div class="mt-3">
                        <small class="text-muted">Utilization Rate</small>
                        <div class="progress-bar-custom">
                            <div class="progress-fill" style="width: <?php echo e($totalCars > 0 ? round((($activeRentals ?? 0) / $totalCars) * 100) : 0); ?>%"></div>
                        </div>
                        <small class="text-muted"><?php echo e($totalCars > 0 ? round((($activeRentals ?? 0) / $totalCars) * 100) : 0); ?>% cars currently in use</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="info-card">
                    ...
                    <div class="stat-item">
                        ...
                        <div class="value">Rp <?php echo e(number_format($totalRevenue ?? 0, 0, ',', '.')); ?></div>
                    </div>
                    ...
                    <div class="stat-item">
                        ...
                        <div class="value">Rp <?php echo e(number_format($monthlyRevenue ?? 0, 0, ',', '.')); ?></div>
                    </div>
                    ...
                    <div class="stat-item">
                        ...
                        <div class="value">Rp <?php echo e(number_format($totalRentals > 0 ? ($totalRevenue ?? 0) / $totalRentals : 0, 0, ',', '.')); ?></div>
                    </div>

                    <div class="mt-3">
                        <small class="text-muted">Monthly Target Progress</small>
                        <div class="progress-bar-custom">
                            <div class="progress-fill" style="width: <?php echo e(($monthlyRevenue ?? 0) > 0 ? min(100, round((($monthlyRevenue ?? 0) / 50000000) * 100)) : 0); ?>%"></div>
                        </div>
                        <small class="text-muted"><?php echo e(($monthlyRevenue ?? 0) > 0 ? min(100, round((($monthlyRevenue ?? 0) / 50000000) * 100)) : 0); ?>% of Rp 50.000.000 target</small>
                    </div>
                </div>
            </div>
                ...
                <div class="info-card">
                    ...
                    <?php if(isset($recentActivities) && count($recentActivities) > 0): ?>
                        ...
                        <div class="activity-item">
                            <div class="activity-icon" style="background: <?php echo e($activity['color'] ?? '#667eea'); ?>">
                                <i class="bi bi-<?php echo e($activity['icon'] ?? 'circle-fill'); ?>"></i>
                            </div>
    ...
    <div class="footer-text text-center mt-5">
        <p>© <?php echo e(date('Y')); ?> Rental Car Management System | Designed with ❤️ using Laravel & Bootstrap</p>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_rentalcar\resources\views/dashboard/index.blade.php ENDPATH**/ ?>